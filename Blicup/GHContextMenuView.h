...
- (NSString *) highLightedTitleForItemAtIndex:(NSInteger) index;
...
@optional
- (UIView *)getSnapViewInCollection:(CGPoint) point;
- (void) contextMenuWillHideforMenuAtPoint:(CGPoint) point;
- (void) shouldAnimateTipPerformed;
@end
