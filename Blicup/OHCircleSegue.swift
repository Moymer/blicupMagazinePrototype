...
class OHCircleSegue: UIStoryboardSegue {
    ...
    private static let contractDur: CFTimeInterval = 0.30
    ...
    override func animationDidStop(anim: CAAnimation, finished flag: Bool) {
        ...
        if !shouldUnwind {
            ...
            NSNotificationCenter.defaultCenter().postNotificationName("animationExpandDidStopCircleSegue", object: nil)
        } else {
